      ...
      <aside className="bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 border-r border-gray-700 w-72 hidden md:flex flex-col shadow-2xl fixed left-0 top-0 h-screen overflow-y-auto">
        ...
        <div className="p-4 border-t border-gray-700 bg-gray-800/50 backdrop-blur-sm flex-shrink-0">
          <div className="flex items-center space-x-3 p-3 bg-gray-700/50 rounded-xl">
            ...
            <button
              className="group flex items-center px-3 py-2 text-sm text-gray-300 hover:bg-red-600 hover:text-white rounded-lg transition-all duration-200 hover:shadow-lg hover:shadow-red-500/25"
              onClick={handleLogout}
            >
              <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-gray-700 group-hover:bg-red-500 transition-all duration-200">
            ...
            <div className="md:hidden fixed inset-y-0 left-0 w-72 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 shadow-2xl z-50 transform transition-transform duration-300 ease-in-out overflow-y-auto">
              ...
              <div className="p-4 border-t border-gray-700 bg-gray-800/50 backdrop-blur-sm flex-shrink-0">
                <div className="flex items-center space-x-3 p-3 bg-gray-700/50 rounded-xl">
                  ...
                  <button
                    className="group flex items-center px-3 py-2 text-sm text-gray-300 hover:bg-red-300 hover:text-white rounded-lg transition-all duration-200 hover:shadow-lg hover:shadow-red-500/25"
                    onClick={() => {
                      setIsSidebarOpen(false);
                      handleLogout();
                    }}
                  >
                    <div className="w-4 h-4 rounded-lg flex items-center justify-center bg-gray-700 group-hover:bg-red-500 transition-all duration-200">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                      </svg>
                    </div>
