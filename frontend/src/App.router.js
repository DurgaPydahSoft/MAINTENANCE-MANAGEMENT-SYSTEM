  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 md:ml-72 min-h-screen flex flex-col">
        {/* Mobile header */}
        <div className="md:hidden w-full bg-white border-b border-gray-200 p-3 flex items-center justify-between flex-shrink-0">
          <button className="text-blue-700" onClick={() => setIsSidebarOpen(!isSidebarOpen)}>Menu</button>
        ...
        {isSidebarOpen && (
          <div className="md:hidden bg-gradient-to-b from-gray-900 to-gray-800 border-b border-gray-700 p-4">
            <nav className="space-y-2">
              <NavLink 
                to="/" 
                end 
                className={({ isActive }) => `flex items-center px-3 py-3 rounded-lg transition-all duration-200 ${
                  isActive 
              ...
              >
                {({ isActive }) => (
                  <>
                    ...
                    <div>
                      <div className="font-medium">Dashboard</div>
                      <div className="text-xs opacity-75">Overview</div>
                    </div>
                  </>
                )}
              </NavLink>
